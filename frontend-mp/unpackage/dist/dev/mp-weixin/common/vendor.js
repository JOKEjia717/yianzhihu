...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__C3DAE8F",
    appName: "yiAnZhiHu-user-front-end",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.32.1,192.168.153.1,192.168.64.156,127.0.0.1,172.28.240.1";
  const port = "8090";
  const id = "mp-weixin__IfZ7R";
